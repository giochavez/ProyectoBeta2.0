...
public class mezclaEA{
  static void sort(List<Integer> l0){
    ...
    File me = new File("Mezcla equilibrada");
    me.mkdir();
    Archivos.crear("Mezcla equilibrada\\F1.txt");
    Archivos.crear("Mezcla equilibrada\\F2.txt");
    Archivos.crear("Mezcla equilibrada\\F0.txt");
    ...
    while(b != tam){
      System.out.println("Iteracion "+n+":");
      repartirClaves("Mezcla equilibrada\\F0.txt",lf,l1,l2,str,str2,n);
    ...
    Archivos.escribir("Mezcla equilibrada\\F1.txt", str);
    Archivos.escribir("Mezcla equilibrada\\F2.txt", str2);
    Archivos.escribir("Mezcla equilibrada\\F0.txt", str0);
    ...
    System.out.println("\n");
    System.out.println("El resultado fue guardado en F0.txt dentro de la carpeta Mezcla equilibrada\n");
  }
  ...
  public static int MezclarClaves(List<ArrayList<Integer>> l1,List<ArrayList<Integer>> l2,List<ArrayList<Integer>> lf,StringBuilder str0,int cont){
    ...
    Archivos.escribir("Mezcla equilibrada\\F0.txt", mezcla);
    mezcla.insert(0,"\n\nIteracion "+cont+":\n");
          ...
          for(i = c ; i < c2;i++){
            if(n%2==0){
              if(i!=0 && i > c)
                ...
                Archivos.escribir("Mezcla equilibrada\\F1.txt",clave1);
            }else{
              if(i!=0 && i > c)
                clave2.append(",");
              clave2.append(datos[i]);
              datos2.add(Integer.parseInt(datos[i]));
              Archivos.escribir("Mezcla equilibrada\\F2.txt",clave2);
            }
          }
          if(n%2==0){
            l1.add(datos1);
